...
in link:../../CONTRIBUTORS.txt[CONTRIBUTORS.txt]. You may distribute it and/or modify it under the terms of either
...
For comments, suggestions, or updating this document please refer to:

https://github.com/ciampix/kicad-doc#contributing

For bug reports, feature suggestion, or helping with KiCad's development see:
...
{docdate}, 
ifdef::revnumber[rev {revnumber}]
ifndef::revnumber[revision unknown]
